...
extension Renderer: MTKViewDelegate {
  ...
  func draw(in view: MTKView) {
    ...
    renderEncoder.setTriangleFillMode(.lines)
      ...
      // set up the uniform matrix values on the swift side
